...
function EventCardWidget2({ imgContent9, eventDescription7, dynamicContentWithShowMoreButton7 }) {
  return (
      ...
      <div className="event-description-container">
        ...
        <div className="event-details-container1">
          ...
          <button className="button-with-icon1">
            ...
            {messages["suite_574_4"]}
          </button>
          {/* Button Component is detected here. We've generated code using HTML. See other options in "Component library" dropdown in Settings */}
          <button className="button-with-icon">
            <SvgIcon2 className="svg-container1" />
            {messages["9886997885_4"]}
          </button>
          {/* Button Component is detected here. We've generated code using HTML. See other options in "Component library" dropdown in Settings */}
          <button className="button-with-icon-and-text">
            <SvgIcon3 className="svg-container1" />
            {messages["oralhowe21yahoocom_4"]}
          </button>
        </div>
      </div>
      {/* Button Component is detected here. We've generated code using HTML. See other options in "Component library" dropdown in Settings */}
      <button className="primary-cta-button">{messages["book_now_5"]}</button>
    </div>
  );
}

export default EventCardWidget2;

    ...
    <div className="ticket-details-container">
      ...
      <div className="product-grid-container">
        <div className="card-container">
          <img
            src="/assets/img_1091_2669_6a18cf.jpeg"
        ...
        <div className="card-container">
          <img
            src="/assets/img_1091_2675_9587d5.jpeg"
            className="image-container-with-text"
          />
          <div className="info-card">
        ...
        <div className="card-container">
          <img
            src="/assets/img_1091_2681_7d2b81.jpeg"
            className="image-container-with-text"
          />
          <div className="info-card">
        ...
        <div className="card-container">
          <img
            src="/assets/img_1091_2687_d744cc.jpeg"
            className="image-container-with-text"
          />
          <div className="info-card">
        ...
        <div className="card-container">
          <img
            src="/assets/img_1091_2693_7a6075.jpeg"
            className="image-container-with-text"
          />
          <div className="info-card">

  ...
  return (
    <div className="global-fashion-fabric-styles">
      ...
      <div className="fabric-gallery-container">
        <img src="/assets/img_1091_2366_1d1ae1.jpeg" className="image-container-with-clipping-path" />
      ...
      <div className="custom-fabric-features-section">
        <div className="custom-fabric-description-container">
          ...
          <p className="custom-fabric-description-style">{messages["we_trusted_partner_offering_crafted_custom_functio"]}</p>

    ...
    <div className="profile-card">
      <div className="personal-details-section1">
        ...
        <div className="personal-details-section2">
          <div className="flex-container-with-items">
            <div className="profile-card">
              <p className="personal-details-heading">{messages["personal_details"]}</p>
              <p className="personal-details-text">{messages["ms_drew_homenick"]}</p>
          ...
          <div className="contact-info-container">
            <div className="profile-card">
              <p className="personal-details-heading">{messages["contact_detail"]}</p>
              <p className="personal-details-text">+123456789</p>
              <p className="personal-details-text">{messages["myemailgmailcom"]}</p>
            </div>
      ...
      <div className="shipping-details-container">
        <div className="address-container">
          <img
            src="/assets/img_1091_4890_234c66.svg"
            alt=""
            className="image-wrapper"
          />
          <div className="address-block">
            <p className="personal-details-heading">{messages["shipping"]}</p>
            <p className="shipping-address-info">{messages["792_cole_wall_new_york_1001_usa"]}</p>
          </div>
        </div>
